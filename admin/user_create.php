    ...
    ?>
        ...
        if (isset($_GET['action']) && $_GET['action'] == 'create') {
            ...
            // POST nhan dc day du username va password
                ...
                $result = mysqli_query($con, "INSERT INTO `customers` (`id`, `username`, `password`, `status`, `created_date`, `last_updated`) 
                VALUES (NULL, '" . $_POST['username'] . "', MD5('" . $_POST['password'] . "'), 1, NOW() , NOW() );");
