<?php
   ...
   <body>      
    ...
    <?php 
        ...
        $totalRecords = mysqli_query($con, "SELECT * FROM `authors`");
        $totalRecords = $totalRecords->num_rows;
        $totalPages = ceil($totalRecords / $item_per_page);
        
        $result = mysqli_query($con, "SELECT * FROM authors ORDER BY `id` DESC LIMIT " . $item_per_page . " OFFSET " . $offset);
        mysqli_close($con);
                        ...
                        <div class="row">
                            <!-- <div id="user-info"> -->
                             <div class="col-xl-12">
                                    ...
                                    <a class="fa fa-user-plus" href="./author_create.php">Tạo tác giả mới</a>
