    ...
    <?php 
        ...
        if (isset($_GET['action']) && $_GET['action'] == 'edit') 
        {
            if (isset($_POST['name']) && !empty($_POST['name']) ) 
            {
                ...
                if ($error !== false) 
                {
                    ...
                    <div id="error-notify" class="box-content">
                        <h1>Thông báo</h1>
                        <h4><?= $error ?></h4>
                        <a href="javascript:window.history.go(-1)">Danh sách tác giả</a>
                    </div>
                <?php } else { ?>
                    <div class="content-container">
                        <div id="edit-notify" class="box-content">
                            <h1><?= ($error !== false) ? $error : "Sửa tác giả thành công" ?></h1>
            ...
            <?php } else { ?>
                <div class="content-container">
                    <div id="edit-notify" class="box-content">
                        <h1>Vui lòng nhập đủ thông tin để sửa tác giả</h1>
                        <a class="button" href="javascript:window.history.go(-1)">Quay lại sửa tác giả</a>
                    </div>
                </div>
            <?php
            }
            ...
            $result = mysqli_query($con, "SELECT * FROM authors where `id`=" . $_GET['id']);
